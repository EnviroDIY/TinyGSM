 ...
 */
/**
 * @defgroup sequans_monarch Sequans Monarch
 * @ingroup group_sequans
...
/// Basic modem configurations for the Sequans Monarch
/// @ingroup sequans_monarch
...
/**
 * @brief TCP behavior and limits for the Sequans Monarch.
 *
